...
SQLCMD.exe -C -S Localhost\SQLEXPRESS -d LANSA -U $sql_username -P $sql_password -i mssql-performance-metrics-literal.sql
SQLCMD.exe -C -S Localhost\SQLEXPRESS -d LANSA -U $sql_username -P $sql_password -i mssql-performance-metrics-bind.sql
