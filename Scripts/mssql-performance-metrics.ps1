...
SQLCMD.exe -S Localhost -d LANSA -U $sql_username -P $sql_password -i mssql-performance-metrics-literal.sql
SQLCMD.exe -S Localhost -d LANSA -U $sql_username -P $sql_password -i mssql-performance-metrics-bind.sql
