...
dbisql -c "UID=$sql_username;PWD=$sql_password;DSN=SQLANYWHERE" -onerror exit -nogui "sqlanywhere-performance-metrics-literal.sql"
dbisql -c "UID=$sql_username;PWD=$sql_password;DSN=SQLANYWHERE" -onerror exit -nogui "sqlanywhere-performance-metrics-bind.sql"
