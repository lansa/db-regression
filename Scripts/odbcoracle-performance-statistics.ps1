...
sqlplus -s -NOLOGINTIME $sql_username/$sql_password@ora19cdb @odbcoracle-performance-statistics-literal.sql
sqlplus -s -NOLOGINTIME $sql_username/$sql_password@ora19cdb @odbcoracle-performance-statistics-bind.sql
