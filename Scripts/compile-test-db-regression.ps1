...
function writings3logs {
    ...
    Set-Location -Path "$root_directory\LANSA\VersionControl\Scripts"

    # This will download the AWS Systems Manager log file(s) locally at the location specified on the "Folder" flag ("$root_directory\LANSA\VersionControl\Scripts")
...
# In case nothing fails, fetch and write the logs
writings3logs # This is a function
