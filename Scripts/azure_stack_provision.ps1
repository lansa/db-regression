...
if($azure_tags -ge 1) {
    ...
    New-AzResourceGroupDeployment -ResourceGroupName dbregressiontest -TemplateFile "./Template/azure/sqlserver.json" -TemplateParameterObject $azure_template_param
